...
gcloud secrets create public_key --data-file credentials/soap/cert/pubkey.pem --replication-policy automatic
gcloud secrets describe private_key || \
gcloud secrets create private_key --data-file credentials/soap/cert/privkey.pem --replication-policy automatic
gcloud projects add-iam-policy-binding $project_id \
